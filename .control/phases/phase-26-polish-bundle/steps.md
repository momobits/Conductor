...
- [x] 26.5 — 2026-05-17 dogfood follow-up: `ui-stream-live-feed-label-clipped-by-work-button` (P3, XS). One-line CSS: add `margin-bottom: 18px` to `#work-btn` in `src/ui/app.css:790` (Option A from issue file) so the `.stream::before` `LIVE FEED ⌁` label sits clear of the button above it.
