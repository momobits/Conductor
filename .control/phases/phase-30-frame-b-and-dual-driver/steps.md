...
- [ ] 30.10 — Dual-driver foundation polish: `dual-driver-halt-categories` (#61) via `/relay-auto --sweep all`. Typed halt taxonomy (~13 named categories) replacing free-string `classifyHalt()`. S complexity. Commits use scope `(30.10)`.
