...
- [ ] 30.8 — Dual-driver Cohort B: `dual-driver-lead-handoff-reconciliation` (#57) via `/relay-auto --sweep all`. First-class feature per brainstorm decision #8: when brain reclaims lead, diff board state since handoff + re-evaluate prior plans per affected card. Blocks #59 brain-loop-replacement. M-L complexity. Commits use scope `(30.8)`.
