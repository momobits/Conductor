...
- [ ] 30.14 — Dual-driver Cohort D / cross-cluster bridge: `dual-driver-frame-b-chat-wire` (#62) via `/relay-auto --sweep all`. Wires Frame B's Card Detail chat panel as second invocation surface to the orchestrator; command-vs-conversation classifier; auto-dispatch per autonomy mode. Depends on #54 ✓, #55 ✓, #59 (lands in 30.13), #60 (lands in 30.7). M complexity. Unblocks Frame B Cohort B #49. Commits use scope `(30.14)`.
