...
**Intra-phase build order (per feature files' Development Order):** #47 ✓ (shipped 2026-05-24 via Control 30.4) ‖ #48 ✓ (shipped 2026-05-24 via Control 30.5; closes 30.4 v1 caveat) → #49 → #50 → #52 (polish, anytime after #47). Cohort A complete; Cohort B (#49) blocks on Phase 22 #62; Cohort C (#50, #52) unblocked. #51 dropped (SUPERSEDED + archived).
