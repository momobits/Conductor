...
- **`dual-driver-lead-handoff-reconciliation.md`** — RESOLVED 2026-05-24 (Control phase 30.8; commit `55f6872`). Snapshot-then-diff reconciliation pass landed as producer-only ship (consumer in future #59); new `src/orchestrator/reconciliation{,-diff}.ts` modules + `runtime.deferredReconciliations` accessors + `conductor-reconciliation-summary` SSE event; see [implementation doc](implemented/dual-driver-lead-handoff-reconciliation.md).
...
| `dual-driver-lead-handoff-reconciliation.md` | individual feature | RESOLVED 2026-05-24 (Control 30.8; `55f6872`) | See [implementation doc](implemented/dual-driver-lead-handoff-reconciliation.md). |
